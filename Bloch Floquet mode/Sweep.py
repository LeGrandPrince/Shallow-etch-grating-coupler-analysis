...
Field_overlap = {'DC=0.3':np.array([0.1118, 0.2906, 0.7019,  0.6254, 0.6168, 0.5946, 0.5609, 0.5322, 0.5403, 0.7746, 0.5236, ]),
                 'DC=0.45':np.array([0.6259, 0.6123, 0.5947, 0.5476, 0.5365, 0.5254, 0.4875, 0.4022, 0.3327, 0.2856, 0.2170]),
                 'DC=0.6':np.array([0.5163, 0.5750, 0.5866, 0.5654, 0.5621, 0.5129, 0.4656, 0.5773, 0.4734, 0.3451, 0.3129]),
