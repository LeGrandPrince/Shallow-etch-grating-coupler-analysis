...
Both functions output pandas DF's, which you can then easily copy from command line and with few steps paste into excel to make neat worksheets. For this purpose, author suggests labeling the data not in this way:{'Label one':data,<br />
                                   'Label two':data,<br />
                                   ...<br />
                                   }<br />
<br />                                                                          
but in this way: {'Label_one':data,<br />
                  'Label_two':data,<br />
                  ...<br />
                 }<br />
<br />                            
